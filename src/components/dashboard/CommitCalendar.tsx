...
export function CommitCalendar() {
  ...
  return (
    <div className="bg-cream border-4 border-dark rounded-2xl p-6 shadow-[6px_6px_0_var(--color-dark)] relative">
      ...
      {hoveredDay && (
        <div
          className="fixed z-50 pointer-events-none bg-dark text-white px-3 py-2 rounded-lg border-2 border-orange shadow-[4px_4px_0_var(--color-dark)] text-sm font-body"
          style={{
